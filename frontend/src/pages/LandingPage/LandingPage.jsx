...
function AnimatedAetherBackground() {
  ...
  React.useEffect(() => {
    ...
    class Particle {
      ...
      draw() {
        const alpha =
          this.baseAlpha + Math.sin(this.pulse) * 0.15;
...
/* ============================================================
   CERTIFICATE RECORD FEATURE
============================================================ */

function CertificateRecordFeature({
  handleCertificateRecord,
}) {
  return (
    <section className="relative overflow-hidden border-y border-white/[0.07] bg-[#050411] py-28 lg:py-36">
      {/* Background grid */}
      <div
      ...
      {/* Ambient glows */}
      <div className="pointer-events-none absolute -left-20 -top-32 h-[420px] w-[420px] rounded-full bg-purple-500/[0.08] blur-[130px]" />

      <div className="pointer-events-none absolute -bottom-40 right-[8%] h-[380px] w-[380px] rounded-full bg-indigo-500/[0.05] blur-[130px]" />

      <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-16 px-6 lg:grid-cols-2 lg:gap-24 lg:px-8">
        {/* LEFT CONTENT */}
        <motion.div
          initial={{
            opacity: 0,
        ...
        >
          <div className="mb-6 flex items-center gap-3">
            ...
            <span className="font-mono text-[10px] uppercase tracking-[0.22em] text-purple-300/65">
              Authentic credentials
            </span>
          </div>

          <h2 className="max-w-2xl text-4xl font-medium leading-[1.05] tracking-[-0.045em] sm:text-5xl lg:text-[64px]">
            Your certificate.
          ...
          <div className="mt-7 max-w-xl space-y-5 text-sm leading-7 text-white/40">
            <p>
              Your issued credentials are securely
              recorded and protected through
              AuthNode's verification infrastructure.
            </p>

            <p>
              Access your certificate details,
              issuance information and verification
              status from one trusted record.
            </p>
          </div>

          <motion.button
            type="button"
            onClick={handleCertificateRecord}
            whileHover={{
              y: -3,
            }}
            whileTap={{
            ...
            className="group mt-9 inline-flex items-center gap-3 rounded-xl border border-purple-300/20 bg-purple-300 px-6 py-3.5 text-sm font-semibold text-[#07101c] shadow-[0_0_40px_rgba(168,85,247,.15)] transition hover:bg-white hover:shadow-[0_14px_45px_rgba(168,85,247,.22)]"
          >
        ...
        >
          <div className="pointer-events-none absolute left-1/2 top-1/2 h-[360px] w-[360px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-purple-500/[0.10] blur-[100px]" />
          ...
          <motion.div
            ...
            className="relative z-10 w-full max-w-[450px] overflow-hidden rounded-[26px] border border-purple-300/20 bg-gradient-to-br from-[#140f28] via-[#0b091c] to-[#070614] p-7 shadow-[0_35px_100px_rgba(0,0,0,.55),0_0_80px_rgba(168,85,247,.06)] backdrop-blur-xl"
          >
            {/* Card top highlight */}
            <div className="absolute left-0 right-0 top-0 h-px bg-gradient-to-r from-transparent via-purple-300/70 to-transparent" />

            {/* Header */}
            <div className="relative flex items-center justify-between">
              <div className="flex h-12 w-12 items-center justify-center rounded-[14px] border border-purple-300/20 bg-purple-500/[0.07]">
                <ShieldCheck
                  size={22}
                  className="text-purple-300"
                />
              ...
              <div className="flex items-center gap-2 rounded-full border border-emerald-400/20 bg-emerald-400/[0.05] px-3 py-2">
                <span className="relative flex h-1.5 w-1.5">
                  ...
                  <span className="relative h-1.5 w-1.5 rounded-full bg-emerald-400 shadow-[0_0_12px_rgba(52,211,153,.8)]" />
                </span>

                <span className="font-mono text-[9px] uppercase tracking-[0.12em] text-emerald-300">
                  Verified
                </span>
              </div>
            </div>
            ...
            <div className="relative mt-12">
              <p className="font-mono text-[9px] uppercase tracking-[0.2em] text-purple-300/55">
                Digital credential
              </p>
              ...
              <p className="mt-3 max-w-sm text-[13px] leading-6 text-white/35">
                This credential is securely recorded
                and independently verifiable through
                cryptographic proof.
              </p>
            </div>
            ...
            <div className="relative mt-8 grid grid-cols-2 gap-3">
              <div className="rounded-[14px] border border-white/[0.07] bg-white/[0.025] p-4">
                <span className="block font-mono text-[8px] uppercase tracking-[0.15em] text-white/25">
                  Proof type
                </span>

                <strong className="mt-2 block text-xs font-medium text-white/65">
                  SHA-256
                </strong>
              </div>
            ...
            <div className="relative mt-7 flex items-center justify-between border-t border-white/[0.07] pt-5">
              <div className="flex items-center gap-2">
                ...
                <span className="font-mono text-[8px] uppercase tracking-[0.16em] text-purple-300/60">
                  Authentic record
                </span>
              </div>
...
export default function LandingPage() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#030712] text-white">
        ...
        <div className="relative z-10 mx-auto flex min-h-[760px] max-w-7xl items-center px-6 py-32 lg:min-h-[820px] lg:px-8">
          <div className="grid w-full items-center gap-16 lg:grid-cols-[1.05fr_.95fr]">
            ...
            >
              ...
              >
                AuthNode transforms academic and
                professional certificates into
                tamper-evident digital credentials
                backed by cryptographic proof and
              ...
              >
                ...
                <p className="text-xs leading-6 text-white/30">
                  <span className="text-white/55">
                    One certificate. One fingerprint.
                    One verifiable proof.
                  </span>{" "}

                  Alter the credential and the
                  cryptographic fingerprint no longer
                  matches.
                </p>
              </motion.div>
            </motion.div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid items-center gap-16 lg:grid-cols-[.9fr_1.1fr]">
            ...
            >
              ...
              <div className="mt-7 max-w-xl space-y-5 text-sm leading-7 text-white/40">
                <p>
                  A certificate may look official, but
                  verifying whether it was actually
                  issued can still become slow and
                  manual.
                </p>

                <p>
                  AuthNode introduces a cryptographic
                  proof layer between the institution
                  that issues a credential and the
                  person who needs to verify it.
                </p>

                <p>
                  Instead of asking someone to simply
                  trust the document, the document can
                  provide evidence of its own
                  authenticity.
                </p>
              </div>
          ...
          <div className="grid items-center gap-16 lg:grid-cols-[.85fr_1.15fr]">
            ...
            >
              ...
              <p className="mt-7 max-w-lg text-sm leading-7 text-white/40">
                A certificate can become part of a
                distributed verification layer.
                Institutions issue the credential,
                blockchain stores the proof, and
      ...
      <section className="relative overflow-hidden border-b border-white/[0.07] py-28 lg:py-36">
        ...
        <div className="relative z-20 mx-auto mb-14 max-w-3xl px-6 text-center lg:mb-16">
          ...
          <p className="mx-auto mt-6 max-w-xl text-sm leading-7 text-white/30">
            A complete credential lifecycle from
      ...
      {/* ======================================================
          CERTIFICATE RECORD CTA
      ====================================================== */}

      <CertificateRecordFeature
        handleCertificateRecord={
          handleCertificateRecord
        }
      />
        ...
        <div className="relative z-10 mx-auto max-w-3xl px-6 text-center lg:px-8">
          ...
          >
            ...
            <p className="mx-auto mt-6 max-w-xl text-sm leading-7 text-white/30 sm:text-base">
              Issue blockchain-backed credentials or
              verify an existing certificate with
              cryptographic proof.
            </p>
